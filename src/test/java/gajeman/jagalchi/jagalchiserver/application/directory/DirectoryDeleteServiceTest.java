...
class DirectoryDeleteServiceTest {
    ...
    @Test
    void when_정상요청이면_하위항목을_루트로_이동하고_삭제한다() {
        ...
        directoryService.delete(10L, 1L);

        assertThat(child.getParentId()).isEqualTo(5L);
        assertThat(roadmap.getDirectoryId()).isEqualTo(5L);
    ...
    void when_디렉토리가_없으면_예외가_발생한다() {
        ...
        assertThatThrownBy(() -> directoryService.delete(10L, 1L))
